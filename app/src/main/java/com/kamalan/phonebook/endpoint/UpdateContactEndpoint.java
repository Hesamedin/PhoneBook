 ...
 */
public class UpdateContactEndpoint extends AsyncTask<Void, Void, Void>
{
    private static final String TAG = UpdateContactEndpoint.class.getSimpleName();
    ...
    public UpdateContactEndpoint(Context context, long contactId, ContactForm contactForm)
    {
    ...
    protected Void doInBackground(Void... params)
    {
        ...
        try
        {
            return mPhonebookAPI.updateContact(mContactId, mContactForm).execute();
        }
